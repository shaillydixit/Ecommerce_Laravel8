          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
              <div class="widget widget_about_us">
                <a class="footer-logo" href="#"><img src="{{asset('')}}frontend/images/logo2.png" alt="Logo"></a>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="widget widget_instagram_feed">
                ...
                <div class="widget-details">
                  <a href="#"><img src="{{asset('frontend/images/instagram/1.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/2.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/3.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/4.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/5.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/6.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/7.png')}}" alt="Instagram Image"></a>
                  <a href="#"><img src="{{asset('frontend/images/instagram/8.png')}}" alt="Instagram Image"></a>
                </div><!-- /.widget-details -->
              </div><!-- /.widget -->
            </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-5 text-right">
            <div class="payment-list">
              <a href="#"><img src="{{asset('frontend/images/payment/1.png')}}" alt="Payment Logo"></a>
              <a href="#"><img src="{{asset('frontend/images/payment/2.png')}}" alt="Payment Logo"></a>
              <a href="#"><img src="{{asset('frontend/images/payment/3.png')}}" alt="Payment Logo"></a>
              <a href="#"><img src="{{asset('frontend/images/payment/4.png')}}" alt="Payment Logo"></a>
              <a href="#"><img src="{{asset('frontend/images/payment/5.png')}}" alt="Payment Logo"></a>
            </div>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container -->
